                                ...
                                <form className="p-4 md:p-5 overflow-y-auto max-h-[75vh]" onSubmit={handleAddTransportSubmit} encType="multipart/form-data">
                                    ...
                                    <div className="grid gap-4 mb-4 grid-cols-2">
                                        <div className="col-span-2">
                                            <label htmlFor="immatricule" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">matricule</label>
                                        ...
                                        <div className="col-span-2">
                                            <label htmlFor="nb_places" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">nombre de place</label>
